...
static std::string builtinPermissionHint(const std::string& name) {
    static const std::unordered_map<std::string, std::string> hints = {
        ...
        {"process_spawn_v2", "permission: process.control"},
        {"wait_process", "permission: process.control"},
        {"process_wait", "permission: process.control"},
        {"kill_process", "permission: process.control"},
        {"process_kill_tree", "permission: process.control"},
        {"process_job_create", "permission: process.control"},
        {"process_job_add", "permission: process.control"},
        {"process_job_kill", "permission: process.control"},
        ...
        {"net_tcp_server", "permission: network.tcp"},
        {"net_tcp_poll", "permission: network.tcp/udp"},
        {"net_dns_lookup", "permission: network.tcp"},
        {"net_tls_connect", "permission: network.tcp"},
        {"net_ws_connect", "permission: network.tcp"},
        {"net_ws_listen", "permission: network.tcp"},
        {"tcp_listen", "permission: network.tcp"},
        {"udp_open", "permission: network.udp"},
        {"fs_fd_open", "permission: filesystem.read"},
        {"fs_fd_close", "permission: filesystem.write"},
        {"fs_fd_read", "permission: filesystem.read"},
        {"fs_fd_write", "permission: filesystem.write"},
        {"fs_fd_pread", "permission: filesystem.read"},
        {"fs_fd_pwrite", "permission: filesystem.write"},
        {"fs_flock", "permission: filesystem.write"},
        {"fs_statx", "permission: filesystem.read"},
        {"fs_atomic_write", "permission: filesystem.write"},
        {"fs_watch", "permission: filesystem.read"},
        {"fs_space", "permission: filesystem.read"},
        {"fs_mounts", "permission: filesystem.read"},
        {"os_signal_trap", "permission: process.control"},
        {"os_signal_untrap", "permission: process.control"},
