...
public:
    ...
    /* * Serialize generated bytecode to a .knb file with ChaCha20 encryption.
     *  @param path  Output file path (e.g., "game.knb")
     *  @param encrypt  If true (default), encrypt payload with ChaCha20
     *  @return true on success, false on failure
     */
    bool saveToFile(const std::string& path, bool encrypt = true) const;
...
private:
    ...
    std::vector<std::unordered_map<std::string, std::string>> typeScopes_;
