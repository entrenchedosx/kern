...
[![Version](https://img.shields.io/badge/version-1.0.11-blue.svg)](KERN_VERSION.txt)
...
- **Version:** `KERN_VERSION.txt` at repo root (e.g. `1.0.11`).
- **Changelog:** [CHANGELOG.md](CHANGELOG.md) follows [Keep a Changelog](https://keepachangelog.com/).
- **Tags:** release tags look like `v1.0.11` (see [docs/RELEASE_CHECKLIST.md](docs/RELEASE_CHECKLIST.md)).
